/**
 * 카테고리별 이미지 장면 프롬프트 (scripts/lib/image-scenes.mjs → .ts 포팅)
 */

import type { Category } from "@/types";

const IMG_PROMPT_SUFFIX =
  "35mm film grain, shot on Canon EOS R5 with 85mm f/1.4 lens, natural available light only, documentary style editorial photography, imperfect authentic details, no AI artifacts, no synthetic look";

const IMG_SCENES: Record<Category, string[]> = {
  "꿈해몽": [
...
export function pickImageScene(category: Category): string {
